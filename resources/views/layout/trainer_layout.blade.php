...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{ asset('css/trainer/custom.css') }}">  
		<link rel="stylesheet" href="{{ asset('css/trainer/ninja-slider.css') }}">  
		<link rel="stylesheet" href="{{ asset('css/trainer/thumbnail-slider.css') }}">  
	...
	<body data-ma-theme="heavy-light-blue">
		 ...
		 <main class="main">
			<aside class="sidebar">
				...
				<div class="scrollbar-inner">
					<ul class="navigation">
						<li class="{{ (Request::is('trainer/dashboard') ? 'navigation__active' : '') }}"><a href="dashboard">Home</a></li>
						<li class="{{ (Request::is('trainer/profile') ? 'navigation__active' : '') }}"><a href="profile">Profile</a></li>
						<li class="{{ (Request::is('trainer/work-record') ? 'navigation__active' : '') }}"><a href="work-record">Work Record</a></li>
						<li class="{{ (Request::is('trainer/feedback') ? 'navigation__active' : '') }}"><a href="feedback">Feedback</a></li>
		...
		<script type="text/javascript" src="{{ asset('js/trainer/app.min.js') }}"></script>
		@yield('scripts')
